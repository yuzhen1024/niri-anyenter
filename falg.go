...
var (
	...
	mode                 = kingpin.Flag("mode", "default mode is preinput mode, in future updates include uinput mode, uinput mode is wip, now only use preinput.").Default("preinput").Enum("preinput")
