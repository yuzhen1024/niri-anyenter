...
var (
	...
	excludeLayers  = kingpin.Flag("exclude-layers", `this will stop launcher run, if layers existing. example: --exclude-layers "app1" "app2" ...`).Default("nwg-drawer", "quickshell:modal").Strings()
